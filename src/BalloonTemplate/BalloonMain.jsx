...
import {IntroMainBalloon} from './components/Intro/Main';
import {BalloonOutroMain} from './components/Outro/OutroMain';
import {BalloonIndividualSegmentMain} from './components/IndividualSegment/IndividualSegmentMain';

export const BalloonMain = () => {
					...
					component: (
						<BalloonIndividualSegmentMain
							...
							slowMotionVideoEnable={
								remotionDetails.remotionPreviewData.slowMotionVideoEnable
							}
							volume={1}
							speed={1}
						/>

...
import {ClassicColorIndividual} from './components/Individual/ClassicIndividual';

export const ClassicColorMain = () => {
	...
	const fetchData = useCallback(async () => {
		await fetch(
			`https://clipping-platform-api-staging.azurewebsites.net/producer/remotion-preview/7e4e730a-b28d-4be5-b357-298708ad6e7f`
		)
